  ...
  <Layout>
    <section className='section-double'>
      <div className='section-content'>
        ...
        <p>
        Le tournant est venu lorsque j'ai découvert l'UX. Je savais que c'était le genre de problèmes que je voulais résoudre. En prenant les compétences créatives que j'avais développées et en les mettant dans le processus structuré de conception <strong>tournée vers et avec</strong> l'utilisateur, j'ai pu réconcilier les deux côtés de mon cerveau !
        </p>
      </div>
